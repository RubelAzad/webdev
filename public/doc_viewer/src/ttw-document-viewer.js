...
var DocumentViewerDependencyLoader = function (loaderOptions) {
    ...
    dependencies = {
        pdfjs:['../../../doc_viewer/libs/pdfjs/compatibility.js', '../../../doc_viewer/libs/pdfjs/pdf.js'],
        prettify:['../../../doc_viewer/libs/google-code-prettify/prettify.js', '../../../doc_viewer/libs/google-code-prettify/prettify.css'],
        flowplayer:['../../../doc_viewer/libs/flowplayer/flowplayer-3.2.6.min.js'],
        jplayer:['../../../doc_viewer/libs/jPlayer/jquery.jplayer.min.js']
    };
...
var DocumentViewer = function (userOptions) {
    var
        ...
        imageExtensions = ['PNG', 'png', 'JPG', 'jpg', 'JPEG', 'jpeg', 'GIF', 'gif'],
...
//
    ...
    DocumentInstance.prototype.loadPdf = function () {
        ...
        function load(filename) {
            ...
            PDFJS.workerSrc = self.path + '../../../doc_viewer/libs/pdfjs/pdf.worker.js';
