...
<div class="form-group">
    {!! htmlspecialchars_decode(Form::label('sender_account', 'Account/Company<span class="star">*</span>', ['class' => 'col-sm-3 control-label'])) !!}
    <div class="col-sm-5">
...
<div class="center">
    <button id="btn_update_sender" class="btn btn-primary"><i class="fa fa-save"></i> Update Sender</button>
    <button id="btn_cancel_update_sender" class="btn btn-danger"><i class="fa fa-times"></i> Cancel</button>
</div>
