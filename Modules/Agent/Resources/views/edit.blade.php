...
@section('page_header')
    <i class="fa fa-sitemap"></i> Edit Agents - {{$agent->name}}
@endsection
...
@section('breadcrumb')
    ...
    @endcan
    <li class="active">Edit Agents - {{$agent->name}}</li>
@endsection

@section('content')

    <div class="panel panel-primary">
        <div class="panel-heading"><h3 class="panel-title">Edit Agent Record</h3></div>
