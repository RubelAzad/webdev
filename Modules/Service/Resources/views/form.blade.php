...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        $("#addsla").click(function(){
            ...
            $("#dynamicTable").append('<tr><td><input type="text" name="addslab['+i+'][minimum_weight]" placeholder="Minimun Kg" class="form-control" /></td><td><input type="text" name="addslab['+i+'][maximum_weight]" placeholder="Maximun Kg" class="form-control" /></td><td><input type="text" name="addslab['+i+'][price]" placeholder="Charge" class="form-control" /></td><td><button type="button" class="btn btn-danger remove-tr">Remove</button></td></tr>');
        });
...
<div class="row">
    <div class="col-sm-6">
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <input type="radio" name="commission" id="credit" value="2">
        ...
        {!! htmlspecialchars_decode(Form::label('slab', '<span class="star">*</span>Slab ', ['class' => 'control-label col-md-4'])) !!}
            <div class="col-md-8">
                <input type="radio" name="commission" id="card" value="1">
                ...
                <table class="table table-bordered" id="dynamicTable">
                    ...
                    <tr>
                        <td><input type="text" name="addslab[0][minimum_weight]" placeholder="Minimun Kg" class="form-control" /></td>
                        <td><input type="text" name="addslab[0][maximum_weight]" placeholder="Maximun Kg" class="form-control" /></td>
                        <td><input type="text" name="addslab[0][price]" placeholder="Charge" class="form-control" /></td>
                        <td><button type="button" name="addsla" id="addsla" class="btn btn-success">Add More</button></td>
                    </tr>
                </table>
                </div>
            </div>
