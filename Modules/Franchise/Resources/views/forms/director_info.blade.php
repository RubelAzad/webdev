{!! Form::open(['url' => url('franchise/add_new_officer'), 'class' => 'form-horizontal', 'id' => 'frm_director_info']) !!}
...
<div class="form-group">
    ...
    <div class="col-md-8">
        {!! Form::select('director_country', $countries, $director ? $director->country : $country, ['class' => 'form-control', 'readonly' => 'readonly', 'required' => 'required']) !!}
    </div>
</div>
