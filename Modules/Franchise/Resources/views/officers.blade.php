        ...
        <tr>
            ...
            <td class="center">
                <div class="btn-group btn-group-sm" role="group">
                    @can('edit_franchise_employees', \Modules\Franchise\Entities\FranchiseEmployee::class)
                        <button data-employee_id="{{$officer->id}}" class="btn btn-warning edit"><i class="fa fa-edit"></i></button>
                    @endcan
                    @can('delete_franchise_employees', \Modules\Franchise\Entities\FranchiseEmployee::class)
                        <a href="{{url('franchise/delete-employee/'. $officer->id)}}" class="btn btn-danger delete"><i class="fa fa-trash"></i></a>
                    @endcan
                </div>
            </td>
        </tr>
