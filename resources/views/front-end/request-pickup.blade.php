            ...
            <div class="container">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        {!! Form::label('quantity', '*Package Quantity', ['class'=> 'control-label col-md-3']) !!}
                        <div class="col-md-8">
                            {!! Form::number('quantity', '', ['class' => 'form-control', 'min' => 1, 'required' => 'required']) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        {!! Form::label('weight', '*Package Weight (kg)', ['class'=> 'control-label col-md-3']) !!}
                        <div class="col-md-8">
                ...
                <fieldset>
                    ...
                    <div id="div_date" class="form-group">
                        {!! Form::label('preferred_date', '*Preferred Date', ['class'=> 'control-label col-md-3']) !!}
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        {!! Form::label('address_line_1', '*Address Line 1', ['class'=> 'control-label col-md-3']) !!}
                        <div class="col-md-8">
                    ...
                    <div class="form-group">
                        {!! Form::label('postcode', '*Postcode', ['class'=> 'control-label col-md-3']) !!}
                        <div class="col-md-8">
