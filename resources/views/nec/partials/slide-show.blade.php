...
<div class="jumbotron jumbotron--with-captions">
    ...
    <div data-interval="5000" data-ride="carousel" id="headerCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            ...
            <div class="item">
                <img alt="UNBEATABLE TRUCKING AND TRANSPORT SERVICES" sizes="100vw" srcset="{{url('img/30.jpg')}} 1920w, {{url('img/30.jpg')}} 425w" src="{{url('img/30.jpg')}}">
                <div class="container">
            ...
            <div class="item">
                <img alt="CRANE TO TRAIN, WE DO EVERYTHING" sizes="100vw" srcset="{{url('img/31.jpg')}} 1920w, {{url('img/31.jpg')}} 425w" src="{{url('img/31.jpg')}}">
                <div class="container">
                    <div class="jumbotron-content">
                        <div class="jumbotron-content__title">
            ...
            <div class="item active">
                <img alt="GROUND OR AIR, THERE IS NO STOPPING FOR US" sizes="100vw" srcset="{{url('img/32.jpg')}} 1920w, {{url('img/32.jpg')}} 425w" src="{{url('img/32.jpg')}}">
                <div class="container">
                    <div class="jumbotron-content">
                        <div class="jumbotron-content__title">
